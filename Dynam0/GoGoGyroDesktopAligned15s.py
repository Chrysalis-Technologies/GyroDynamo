...
class GoGoGyroAligned:
    def __init__(self, width=900, height=900):
        ...
        pygame.display.set_caption("GoGoGyro Aligned 15s")
...
def main():
    parser = argparse.ArgumentParser(description="Aligned ring variant (15s align, no UI controls)")
