...
class GoGoGyroAligned:
    def __init__(self, width=900, height=900):
        ...
        pygame.display.set_caption("GoGoGyro Aligned 30s")
...
def main():
    parser = argparse.ArgumentParser(description="Aligned ring variant (30s align, no UI controls)")
